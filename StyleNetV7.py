### THIS CODE IS LARGELY NOT MY OWN
### Everything here is made utilizing code provided on the tensorflow website and is based off of
### 'A neural style transfer algorithm' by Gatys et al
